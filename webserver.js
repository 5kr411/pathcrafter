...
const {
  ...
  NestedStateMachine
} = require('./node_modules/mineflayer-statemachine')
...
for (i = 1; i <= 5; i++) {
  const bot = mineflayer.createBot({
    ...
    username: process.argv[4] ? process.argv[4] : 'bot_' + i,
  ...
  bot.once('spawn', () => {
    ...
    const getClosestPlayer = new BehaviorGetClosestEntity(bot, targets, (entity) => {
