...
class BehaviorFindBlock {
    ...
    onStateEntered() {
        ...
        console.log("Found block position:", this.targets.position);
    }
    matchesBlock(block) {
    ...
    addExcludedPosition(position) {
        ...
        console.log(`Added excluded position: ${posKey}`);
        console.log(`Total excluded positions: ${this.excludedPositions.size}`);
    }
