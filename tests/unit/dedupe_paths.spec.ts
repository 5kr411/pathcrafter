...
describe('unit: dedupePaths', () => {
    test('removes exact duplicate paths', () => {
        const p1: ActionStep[] = [{ action: 'mine', what: 'stone', count: 1 }];
        const p2: ActionStep[] = [{ action: 'mine', what: 'stone', count: 1 }];
        const p3: ActionStep[] = [{ action: 'mine', what: 'coal_ore', count: 1 }];
    ...
    test('keeps distinct paths differing by any step field', () => {
        const a: ActionStep[] = [{ action: 'mine', what: 'stone', count: 1 }];
        const b: ActionStep[] = [{ action: 'mine', what: 'stone', count: 2 }];
        const c: ActionStep[] = [{ action: 'mine', what: 'stone', count: 1, tool: 'wooden_pickaxe' }];
