...
const { enumerateActionPathsGenerator } = require('../../path_generators/actionPathsGenerator')
...
describe('unit: planner world-pruning (generic wood disabled)', () => {
  ...
  test('insufficient ore count prunes mining paths', () => {
    ...
    const worldSnapshot = {
      version: '1.20.1', dimension: 'overworld', center: { x: 0, y: 64, z: 0 }, chunkRadius: 1, yMin: 0, yMax: 255,
